...
namespace Constants{
 ...
 /////////////////////////////////////////
  ...
  double x_label_offset = 1.4; //RoOT how far to offset x axis label
  double y_label_offset = 1.5; //ROOT how far to offset y axis label
 ...
 ////////////////////////////////////////////////////////////////////
  ...
  const char* other_eff_titles[num_other_eff] = {"cos(#gamma_{p_{L},p_{R}})","cos(#gamma_{1#mu2p COM}","cos(#gamma_{#mu,p_{L}})","cos(#gamma_{#mu,p_{sum})","#delta P_{T} (GeV/c)","#delta #alpha_{T} (Deg.)","#delta #phi_{T} (Deg.)"};
 ...
 ///////////////////////////
  ...
  const char* physics_titles[num_phys] = {"cos(#gamma_{#vec{p}_{L}, #vec{p}_{R}})","cos(#gamma_{#vec{p}_{#mu}, #vec{p}_{sum}})"};//,"P^{T}_{Miss}^{2} (GeV^{2}/c^{2})","Momentum of Struck Nucleon (GeV)","Total P_{z} of the Two Protons", "Total Kinetic Energy of System (GeV/c)","Total Kinetic Energy - Beam Energy (MeV/c)"};
  ...
  */
  ...
  int phys_ylim[num_runs][num_phys] = {{60,60},//jan
				       ...
				       {2000,1700}}; //runs 1+2+3 xsec binning
