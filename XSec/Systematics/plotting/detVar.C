...
void detVar::main(){
  ...
  for(int j=0; j < num_var; j++){
    ...
    make_total_covariance_matrix(Form("_muon%s",var0[j]),Form("Total DetVar Error: Muon %s",var_titles[j]),muon_2D,"detVar/Total");
    ...
    make_total_covariance_matrix(Form("_leading%s",var0[j]),Form("Total DetVar Error: Leading Proton %s",var_titles[j]),leading_2D,"detVar/Total");
    
    plot_total_error(Form("_recoil%s",var0[j]),flip_legend_recoil[j],recoil,Form("Recoil Proton %s",var_titles[j]),h_recoil_total[j]);
    make_total_covariance_matrix(Form("_recoil%s",var0[j]),Form("Total DetVar Error: Recoil Proton %s",var_titles[j]),recoil_2D,"detVar/Total");
  ...
  for(int j=0; j < num_other_var; j++){
    ...
    make_total_covariance_matrix(Form("%s",other_var[j]),Form("Total DetVar Error: %s",other_var_titles[j]),other_2D,"detVar/Total");
  }
...
//////////////
void detVar::plot_total_error(const char* variable, bool flip_legend, std::vector<TH1D*> hist,const char* title, TH1D* h_total){
