void plot_multisims(const char* variable, const char* title, TCanvas* canv, TLegend* legend, std::vector<TH1D*> hist, TH1D* hist_CV, double ymin, double ymax, int num_universes, const char* directory){
